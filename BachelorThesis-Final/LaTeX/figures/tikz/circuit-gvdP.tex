...
\draw(-4,4) -- (-4,6) -- (-14,6) -- (-14,3) to[current source] (-14,0) to[rmeter,t=A](-14,-3)-- (-14,-6) --(-12,-6);
\draw(-12,6) to[rmeter,t=V, *-*]  (-12,-6) -- (-4,-6)--(-4,-4);
\node at(-14,1.5) [left=10pt] {$I_{\text{34}}$};
\node at(-12,0) [right=10pt] {$V_{\text{34}}$};
...
\draw(4,-4) to[rmeter,t=V, -*] (10,-4);
\draw (4,4) to[rmeter,t=V] (10,4) -- (10,-6);

\node at(7,-4) [above=12pt] {$V_{\text{14}}$};
\node at(7,4) [above=12pt] {$V_{\text{24}}$};
