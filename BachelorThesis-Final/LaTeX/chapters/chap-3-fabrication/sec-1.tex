...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{1.8cm}|p{3.2cm}|p{5cm}|}
        ...
        \hline
    \end{tabular}
    \caption[Layer sequence of the fabricated device]{Layer sequence of the fabricated device, including material thicknesses. Adapted from Ref.~\cite{Kersting2026FiguresCollection}.}
