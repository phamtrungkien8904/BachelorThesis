...
Contact effects are a major limitation in OFET mobility extraction. At
...
directly to two-terminal data \cite{Bittle2016MobilityOverestimation}. A high
apparent mobility is therefore not sufficient evidence for fast transport in the
semiconductor film.
...
history. For this reason, this thesis combines setup tests, device fabrication,
conventional transistor measurements, current-driven gated van der Pauw analysis,
background-resistance extraction, DLTS-type transients, and a simple amplifier
test.
