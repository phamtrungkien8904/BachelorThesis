...
\subsection{Charge Carriers Statistics and Transport}
...
\begin{figure}[h]
    ...
    \caption[Carrier concentrations in intrinsic (left) and p-type (right) semiconductors]{Carrier concentrations in intrinsic (left) and p-type (right) semiconductors. In an intrinsic semiconductor, electron and hole concentrations are equal, $n=p=n_i$. Doping shifts the Fermi level and changes the majority and minority carrier densities.}
...
\begin{equation}
    p_\text{2D} \approx \frac{C_\mathrm{i}|V_\mathrm{G}-V_\mathrm{th}|}{e}.
\end{equation}
Here $V_\mathrm{th}$ represents flat-band shifts, trap filling, and contact
