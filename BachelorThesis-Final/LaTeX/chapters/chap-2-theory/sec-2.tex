...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \resizebox{0.95\linewidth}{!}{\input{figures/tikz/C8BTBT.tex}}\par
        \vspace{0.5em}
        C8-BTBT
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \resizebox{0.95\linewidth}{!}{\input{figures/tikz/C12BTBT.tex}}\par
        \vspace{0.5em}
        C12-BTBT
    \end{minipage}
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \resizebox{0.95\linewidth}{!}{\input{figures/tikz/DNTT.tex}}\par
        \vspace{0.5em}
        DNTT
    \end{minipage}\hspace{18mm}
    \begin{minipage}{0.4\textwidth}
        \centering
        \resizebox{0.95\linewidth}{!}{\input{figures/tikz/PhBTBT.tex}}\par
        \vspace{0.5em}
        Ph-BTBT
    \end{minipage}
...
semiconductors. The highest occupied molecular orbital (HOMO) is analogous to the
valence band of an inorganic semiconductor, while the lowest unoccupied molecular
orbital (LUMO) is analogous to the conduction band. Their energetic separation is
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/tikz/ethene-1.tex}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.51\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/tikz/ethene-2.tex}}
    \end{minipage}
