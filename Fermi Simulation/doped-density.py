...
plt.text(0.01, E_L + 0.8, r'$n$', color='black', fontsize=8, ha='center', va='center')
plt.text(0.01, E_V - 0.8, r'$p$', color='black', fontsize=8, ha='center', va='center')
...
plt.legend()
plt.savefig('doped_density.eps', format='eps')
plt.show()
