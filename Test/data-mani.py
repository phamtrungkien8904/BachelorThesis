...
# File paths
# ============================================================
input_file = "./Data-Mani/003.dat"
output_file = "./Data-Mani/003.dat"
...
alpha = 1 # to modify mobility (>1 to decrease, <1 to increase)
offset_1 = 0.0 # to modify V14
offset_2 = 0.0 # to modify V24
data1[:, 4] *= alpha # col 5: V14
data1[:, 4] += offset_1 # col 5: V14
data1[:, 5] *= alpha # col 6: V24
data1[:, 5] += offset_2 # col 6: V24
