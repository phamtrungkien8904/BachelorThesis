...
fig3.suptitle('File 03: Charge Density and Potential Distribution (V34 = -2 V)')
...
ax1.plot(y, p_3[:, 0], 'r-', linewidth=2, label='V34 = -2 V')
ax1.plot(y, p_2[:, 0], 'k-', linewidth=2, label='V34 = -1 V')
...
ax2.plot(y, V_3[:, 0], 'r-', linewidth=2, label='V34 = -2 V')
ax2.plot(y, V_2[:, 0], 'k-', linewidth=2, label='V34 = -1 V')
