...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption[Layer and contact schematic of the thin film structure]{Schematic representation of the assembled thin film structure. The left panel shows the top-view contact layout, while the right panel shows the corresponding 3D layer structure.}
